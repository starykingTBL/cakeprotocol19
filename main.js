...
const MUSIC_URL = 'https://cdn.pixabay.com/audio/2024/03/10/audio_8cb747b636.mp3';
const MUSIC_FALLBACK = 'https://cdn.pixabay.com/audio/2022/08/04/audio_2dde668d05.mp3';
...
function tryPlay(){
  ...
  bgMusic.play().catch(()=>{
    ['touchstart','touchend','click','keydown'].forEach(ev =>
      document.addEventListener(ev, attempt, { once:true })
    );
  });
}
